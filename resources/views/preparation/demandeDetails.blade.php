                            ...
                            @if(count($echantillons)==0)
                                <tr>
                                    <th scope="col" colspan="6">
                                        Pour cette demandes les echantillons sont deja enregistrés, cliquer sur modifier pour changer les valeurs
                                    </th>
                                </tr>
                            @else
                            <?php
                            $nb=1;
                                foreach ($echantillons as $echantillon) {
                                    ...
                                    <tr class="line" >
                                            ...
                                            <td>
                                                <input type="number"  step="0.0001" class="form-control autoIntMasse" min="0" name="<?=$nameMasse?>" placeholder="Entrer la masse ici" required>
                                            </td>
                                            <td>
                                                <input type="number"  step="0.0001" class="form-control autoIntVolume" min="0" name="<?=$nameVolume?>" placeholder="Entrer le Volume ici" required>
                                            </td>
                                            <td>
                                                <input type="number" step="0.0001" class="form-control autoIntVolumeD" min="0" name="<?=$nameVolumeD?>" placeholder="Entrer le Volume ici" required>
                                            </td>
                                            <td>
                                                <input type="number"  step="0.0001" class="form-control autoIntVolumePD" min="0" name="<?=$PD?>" placeholder="Entrer le Volume ici" required>
                                            </td>
                                    </tr>
