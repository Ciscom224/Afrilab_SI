...
<html>
    ...
    <body>
        <a class="nav-link" href="{{route('home')}}">
            <img src="{{ url('Images/logoAfriLab.png') }}" style="width: 25%;
                                position:absolute
                                ">
        </a>
        <div class="container">
           ...
           <h1 class="second-four">4</h1>
            <p class="wrong-para">{{$message}}
                <br>
                <a href="{{$retourPage}}"><button class="btn btn-danger">Retour</button></a>
    ...
    <style>
        ...
        *{
        ...
        height:40vmin;
        border-radius:50%;
        border:6vmin solid #f9bc14;
        position: relative;
        }


        .cog2{
        border:6vmin solid #034a78;
        }
